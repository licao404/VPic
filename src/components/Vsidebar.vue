      ...
      <el-submenu index="1">
        ...
        <el-submenu index="1-1">
          ...
          <el-menu-item-group @click="setAspectRatio">
            ...
            <el-menu-item index="1-1-4">2:3</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-menu-item index="1-2">自由裁切</el-menu-item>
      </el-submenu>
      <el-submenu index="2">
...
<style>
  ...
  .el-submenu .el-menu-item { padding: 0 30px !important; border-bottom: 1px solid #3c3f43; border-top: 1px solid #3c3f43; }
  /*.el-menu */
